    ...
    attach: function ( context, settings ) {
      ...
      Bullet = function () {
        ...
        this.preMove = function (delta) {
          ...
          if (this.time > 150) { // The time the bullet is visible
            this.visible = false;
            this.time = 0;
          }
        };
      ...
      Text = {
        ...
        renderText: function(text, size, x, y) {
          ...
          var pixels = size * 82 / (this.face.resolution * 100);
      ...
      SFX = {
        laser:     new Audio('/sites/all/themes/fldc17/js/vendor/39459__THE_bizniss__laser.wav'),
        explosion: new Audio('/sites/all/themes/fldc17/js/vendor/51467__smcameron__missile_explosion.wav')
      };
