...
if (file_exists('/var/www/site-php')) {
  require('/var/www/site-php/fldrupalcamp/fldrupalcamp-settings.inc');
}
...
$conf['preprocess_css'] = 1;      // disable css aggregation
$conf['preprocess_js'] = 1;       // disable js aggregation
